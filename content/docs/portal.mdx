...
To access the portal, customers must request an access link via email. This link is valid for 48 hours. Customers can request the portal access link here: https://keyforge.dev/portal/request.
