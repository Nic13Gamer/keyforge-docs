...
Now click on "Connect product".

Your Stripe accounts and products will be listed automatically. Select the Stripe product you want to connect, and choose the Keyforge product that customers will receive a license for when they purchase the Stripe product.
