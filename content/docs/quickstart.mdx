...
- Get your user ID [here](https://keyforge.dev/dashboard).
...
When your app starts, you can validate the license to check if it's valid. Here is how to make the HTTP request. You will need either the product ID or your user ID to validate the license, or you can use both.
...
const res = await fetch(
  'https://keyforge.dev/api/v1/public/licenses/validate',
  {
    ...
    body: JSON.stringify({
      ...
      userId: '05d27bfb-61c7-45f7-9d07-09a41defc88a', // use this or the productId
      productId: 'p_123456', // use this or your userId
    }),
  }
);
...
The first time a user opens your app, they should be prompted to activate their license. Here is how to make the HTTP request. You will need either the product ID or your user ID to validate the license, or you can use both.
