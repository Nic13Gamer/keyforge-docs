...
You have successfully created, activated, and validated your first license. You can manage all your licenses in the [dashboard](https://keyforge.dev/dashboard/licenses).
